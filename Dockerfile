...
CMD ["sh -c","ant RunLocalBuildServer > build.log 2>&1 & echo y | /home/google-cloud-sdk/bin/java_dev_appserver.sh --port=8888 --address=0.0.0.0 /APP/appinventor/appengine/build/war/"]
